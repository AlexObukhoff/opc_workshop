...
public:
	...
	void value( LPCTSTR str )
	{
		...
		switch(m_Type) {
			...
			case VT_I1:  m_Value.bVal = (BYTE)_tstoi(str);	break;
			case VT_I2:  m_Value.iVal = (short)_tstoi(str);	break;
			case VT_I4:  m_Value.lVal = (long)_tstol(str);	break;
			case VT_I8:  m_Value.llVal = (LONGLONG)_tstoi64(str);	break;
			case VT_R4:  m_Value.fltVal = (float)_tstof(str);	break;
			case VT_R8:  m_Value.dblVal = _tstof(str);	break;
			case VT_UI1: m_Value.bVal = (BYTE)_tstoi(str);	break;
			case VT_UI2: m_Value.uiVal = (USHORT)_tstoi(str);	break;
